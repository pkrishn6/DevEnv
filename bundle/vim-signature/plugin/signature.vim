...
if !has_key( g:SignatureMap, 'PurgeMarkers'      ) | let g:SignatureMap['PurgeMarkers'     ] = "<Delete>"    | endif
if !has_key( g:SignatureMap, 'GotoNextLineAlpha' ) | let g:SignatureMap['GotoNextLineAlpha'] = "2]"      | endif
if !has_key( g:SignatureMap, 'GotoPrevLineAlpha' ) | let g:SignatureMap['GotoPrevLineAlpha'] = "2["      | endif
if !has_key( g:SignatureMap, 'GotoNextSpotAlpha' ) | let g:SignatureMap['GotoNextSpotAlpha'] = "1]"      | endif
if !has_key( g:SignatureMap, 'GotoPrevSpotAlpha' ) | let g:SignatureMap['GotoPrevSpotAlpha'] = "1["      | endif
